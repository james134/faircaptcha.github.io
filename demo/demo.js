	    ...
	    if (mic_auth) {
            ...
            */
            ...
            faircaptcha_recorder = new WebAudioRecorder(input, {
                ...
                onEncoderLoading: function(faircaptcha_recorder, encoding) {
                    // show "loading encoder..." display
                    faircaptcha_log("Loading "+encoding+" encoder...");
                },
                onEncoderLoaded: function(faircaptcha_recorder, encoding) {
                    // hide "loading encoder..." display
                    faircaptcha_log(encoding+" encoder loaded");
                }
            });
            console.log("red   ",faircaptcha_recorder)
            faircaptcha_recorder.onComplete = function(faircaptcha_recorder, blob) { 
                faircaptcha_log("Encoding complete");
                faircaptcha_handleBlob(blob,faircaptcha_recorder.encoding);
            }
